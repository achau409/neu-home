...
const ZipCodeBlock: React.FC<ZipCodeBlockProps> = ({
  ...
  return (
    ...
    >
      <h2 className="text-2xl md:text-5xl font-bold mb-4">{heading}</h2>
      <h4 className="text-lg font-medium mb-3">{subheading}</h4>
      ...
      {belowTextEnabled && belowText && (
        <div className="mt-6 text-lg">{belowText}</div>
      )}
    </div>
  );
};
