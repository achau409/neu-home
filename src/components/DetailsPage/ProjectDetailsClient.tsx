...
const ProjectDetailsClient = ({ serviceData, initialUserCity = "", variant }: ProjectDetailsClientProps) => {
  ...
  return (
    <div className="relative z-[50] w-full  mx-auto px-4 md:px-6 flex flex-col items-center text-center">
      ...
      {/* Eyebrow pill */}
      <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 md:py-1.5 mb-5">
      ...
      <div className="fixed bottom-4 right-5 z-[50] flex flex-col items-end gap-2 transition-all duration-500 opacity-100 translate-y-0">
        ...
        <button
          className="relative capitalize flex items-center gap-2 bg-[#55BC7E] hover:bg-[#22963c] text-white  font-bold px-5 py-3.5 rounded-full shadow-[0_8px_30px_rgba(40,167,69,0.5)] hover:shadow-[0_8px_40px_rgba(40,167,69,0.7)] transition-all duration-300 hover:scale-105 active:scale-95 group"
